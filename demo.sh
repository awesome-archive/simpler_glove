...
build/glove -threads 8 -vector-size 128 -binary 2 -model 0 -write-header 1 -iter 25 -input-file tmp/corpus_cooccur_shuffle.glove -vocab-file tmp/corpus_vocab.glove -save-file output/baike.128.glove
